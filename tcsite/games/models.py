...
class Game(SortableMixin):
    ...
    top_image = models.ImageField('Картинка-заставка 1600 на 1066', upload_to='games/top_images')
    name=models.CharField('Название работы (крупное на заставке)', max_length=49)
    preview_image = models.ImageField('Картинка предпросмотра 800 на 600', upload_to='games/preview_images')
    ...
    midlle_title=models.CharField('Заголовок 2',max_length=49, blank=True)
    middle_description=models.TextField('Текст 2', blank=True)
    bottom_title=models.CharField('Заголовок 3', max_length=49, blank=True)
    bottom_description=models.TextField('Текст 3', blank=True)
...
class Screenshot(SortableMixin):
    ...
    screenshot_image=models.ImageField('Картинка 1000 на 600', upload_to='games/instance')
...
class Media(models.Model):
    image=models.ImageField('Картинка 1600 на 1060', upload_to='games/main_top_image')
